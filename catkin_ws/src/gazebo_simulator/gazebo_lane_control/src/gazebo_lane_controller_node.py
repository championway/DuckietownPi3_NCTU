...
class lane_controller(object):
    def __init__(self):
        ...
        #self.pub_car_twist = rospy.Publisher("/cmd_vel_lane",Twist,queue_size=1)
    ...
    def cbPose(self,lane_pose_msg):
        ...
        cross_track_err = lane_pose_msg.d - 0.7
        ...
        # transfer duckietown_msgs/TwistStamped to geometry_msgs/Twist
        # /brian
        car_twist_msg = Twist()
        #car_twist_msg.linear.x = 0.4 * math.cos(car_control_msg.omega)
        #car_twist_msg.linear.y = 0.4 * -math.sin(car_control_msg.omega)
        ...
        '''
        car_twist_msg.linear.x = 0.35
        car_twist_msg.angular.z = car_control_msg.omega*1.5


        """
        if(abs(heading_err) < 0.34):
            car_twist_msg.linear.x = 0.4
        ...
        if(abs(heading_err) < 0.34):
            ...
            car_twist_msg.angular.z = 0
        """
        #if(abs(heading_err) <= 0.22): 
        #car_twist_msg.angular.z = heading_err
        #car_twist_msg.angular.x = car_control_msg.omega       
